    ...
    const leftGraphVariants = {
      ...
      return (
        ...
        <Grid ref={articleRef} templateColumns="2fr 6fr 1fr 6fr 1fr" h="110vh">
            ...
            <Box></Box>
            <MotionBox ref={ref2} variants={exitVariants} exit="exit" animate={animation3}><Article article={article3}/></MotionBox>
            <Box></Box>
            <MotionBox ref={ref2} variants={exitVariants} exit="exit" animate={animation3}><Article article={article4}/></MotionBox>
            <Box></Box>
        </Grid>
