...
function Article(props) {
    ...
    return (
        <MotionBox initial={{scale:0, opacity:0}} animate={{scale:1, opacity:1, duration:5}} whileHover={{ scale:1.1}} marginTop="100px" h="600px" bgColor="#1b222d" borderRadius="4%" overflow="scroll">
